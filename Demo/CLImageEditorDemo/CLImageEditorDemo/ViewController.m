...
@interface ViewController () <CLImageEditorDelegate, CLImageEditorTransitionDelegate, CLImageEditorThemeDelegate>
@end
...
- (void)pushedEditBtn {
    if (_imageView.image) {
        ...
        for (NSString *a in arr) {
            CLImageToolInfo *tool = [editor.toolInfo subToolInfoWithToolName:a recursive:NO];
            tool.available = NO;
        }
...
- (void)pushedSaveBtn {
    if (_imageView.image) {
        ...
        UIActivityViewController *activityView =
            [[UIActivityViewController alloc] initWithActivityItems:@[ _imageView.image ] applicationActivities:nil];
