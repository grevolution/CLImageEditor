...
- (void)initNavigationBar {
    ...
    if (![doneBtnTitle isEqualToString:@"CLImageEditor_DoneBtnTitle"]) {
        rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:doneBtnTitle
    ...
    if (_navigationBar == nil) {
        ...
        navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemCancel
                                                                                         target:self
                                                                                         action:@selector(pushedCloseBtn:)];
...
- (void)swapToolBarWithEditting:(BOOL)editting {
    ...
    if (self.currentTool) {
        ...
        item.rightBarButtonItem = [[UIBarButtonItem alloc]
            initWithTitle:[CLImageEditorTheme localizedString:@"CLImageEditor_OKBtnTitle" withDefault:@"OK"]
                    style:UIBarButtonItemStyleDone
                   target:self
                   action:@selector(pushedDoneBtn:)];
        item.leftBarButtonItem = [[UIBarButtonItem alloc]
            initWithTitle:[CLImageEditorTheme localizedString:@"CLImageEditor_BackBtnTitle" withDefault:@"Back"]
                    style:UIBarButtonItemStylePlain
                   target:self
                   action:@selector(pushedCancelBtn:)];
